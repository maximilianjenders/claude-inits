...
3. Write plan to `docs/plans/YYYY-MM-DD-<fix-name>/` following `./skills/shared/plan-folder-structure.md` (relative to project root; use `<fix-name>` as the kebab-case feature name)
